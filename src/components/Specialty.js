...
const specialties = [
  ...
  },
  {
    ...
    description: `Frameworks: Reactjs, Expressjs, FastAPI, MariaDB, Redis, Git, Numpy, Pandas, OpenCV, Tensorflow, and others
    Languages: C++, Python, SQL, HTML, CSS, JavaScript, and others`,
  ...
  <section className='section' id='specialty'>
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        ...
        >
          <h2 className='h2 text-accent mb-6'>My Areas of Expertise</h2>
